...
const ALX = {
  ...
  PHASES: [
    ...
    },
    {
      ...
      days: [
        { id: 6, label: "Tue · Day 6", tag: "Retro", title: "Retrospective & Kickoff",
          desc: "Analysis of Week 1 engagement metrics, and the second project kick-off." },
        { id: 7, label: "Wed · Day 7", tag: "Strategy", title: "Acquisition Strategy",
          desc: "Design an engaging presentation deck optimized for converting prospective learners." },
        { id: 8, label: "Thu · Day 8", tag: "Campaign", title: "Targeted Campaign",
          desc: "Marketing assets deployed across networks. Close coordination with Community Ambassadors to source warm pipelines." },
        { id: 9, label: "Fri · Day 9", tag: "Ops", title: "Operational Efficiency & Polishing",
          desc: "Secure digital signup pathways (QR codes / forms), validate RSVP data, finalize catering, and run mock pitch sessions for delivery and room prep." },
        { id: 10, label: "Sat · Day 10", tag: "flag", title: "The Grand Finale",
